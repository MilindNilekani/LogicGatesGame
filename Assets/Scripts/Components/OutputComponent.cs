...
public class OutputComponent : VirtualComponent {
	...
	public OutputComponent(IVector3 pos, GridHandler.ComponentDirection dir)
	{
		_direction = dir;
		_position = pos;
	}
	...
	public override IVector3 MoveElectron()
	{
		...
		if (GameHandler.instance._grid.isOnGrid (electronPos.x, electronPos.y, electronPos.z)) {
			Debug.Log ("Output"+Position + "," + Direction + "=" + electronPos);
			return electronPos;
		} else {
